          ...
          <div className="flex items-center gap-3">
            ...
            {onBack && (
              <button
                onClick={onBack}
                title="Back to Home"
                className="px-3 py-1.5 rounded-xl bg-[var(--color-bg-control)] hover:bg-[var(--color-bg-surface-elevated)] text-[var(--color-label-secondary)] hover:text-[var(--color-label-primary)] border border-[var(--color-border-subtle)] text-xs font-semibold flex items-center gap-1.5 transition-all cursor-pointer active:scale-95"
              >
